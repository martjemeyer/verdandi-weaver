...
number: 3
displayOrder: 3
title: Kan nya sätt att tänka skapa ett nytt samhälle? | Rethinking Society avsnitt 3
question: Vad skulle förändras om politik sågs som vårt gemensamma ansvar att ta
...
videoUrl: https://youtu.be/zzwfkVlmn_U
resources:
  - language: Swedish
    type: One-Page Conversation Starter
    title: Gratis Samtalsstartare
    format: PDF
    price_type: Paid
...
runtime: 1:21:18
themes:
  - theme: Politik som omsorg om helheten
  - theme: Makt kontra ansvar
  - theme: Levd erfarenhet i beslutsfattande
  - theme: Långsiktigt tänkande
quotes:
  - text: Omsorg står inte utanför politiken. Omsorg är vad politiken blir när
